  ...
  public ProductAiResponse generateFromImage(ProductAiRequest request) {
    String prompt =
      "아래 이미지는 전자기기 혹은 IT 관련 중고상품입니다.\n" +
        ...
        "[스마트폰, 태블릿, 스마트워치, 휴대폰 액세서리, 노트북, 세탁기, 전자레인지, 청소기, 에어컨, DSLR, 미러리스, 액션캠, 캠코더, 렌즈, 이어폰, 헤드폰, 블루투스 스피커, 마이크, 오디오 인터페이스, 닌텐도 스위치, 플레이스테이션, 엑스박스, 게임 타이틀, 게임 컨트롤러, 라우터/공유기, 전자사전, 프로젝터, 외장하드, 웨어러블 기기, 기타]\n" +
